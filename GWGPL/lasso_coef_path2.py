...
if __name__ == '__main__':
    ...
    for i in range(len(lamda)):
        for repeat in range(repeat_number):
            ...
            try:
                ...
                coef_matrix_sim[repeat, :] = simultaneous_model.coef_.reshape((l,p))[:, 10].reshape(1, -1)
                ...
                for loc in range(len(g_coords)):
                    ...
                    coef_matrix_weight_lasso[repeat, loc] = weight_lasso_model.coef_[:, 10]
                ...
                for loc in range(len(g_coords)):
                    ...
                    coef_matrix_lasso[repeat, loc] = lasso_model.coef_[:, 10]
            except:
                continue
    ...
    print('**********存储最终系数中........************')
    output_dir = 'lasso_path_fixed_location_1_fen/'
    if output_dir[-1] != "/":
        output_dir += "/"
